...
TEAM_LOGOS = {
    "Mercedes": "team_logos/mercedes.png", "Ferrari": "team_logos/ferrari.png", "McLaren": "team_logos/mclaren.png",
    "Red Bull Racing": "team_logos/redbull.png", "Unknown": "team_logos/Unknown.png"
}

# Dynamic Track Shapes Database
TRACK_METRICS = {
    "Australia": {"name": "Albert Park Circuit"}, "China": {"name": "Shanghai Circuit"},
    "Japan": {"name": "Suzuka Racing Course"}, "Bahrain": {"name": "Bahrain Circuit"},
    "Saudi Arabia": {"name": "Jeddah Corniche Circuit"}, "Miami": {"name": "Miami Autodrome"},
    "Canada": {"name": "Circuit Gilles-Villeneuve"}, "Monaco": {"name": "Circuit de Monaco"},
    "Spain (Barcelona)": {"name": "Circuit de Barcelona-Catalunya"},
    "Austria": {"name": "Red Bull Ring (Spielberg)"}, "Great Britain": {"name": "Silverstone Circuit"},
    "Belgium": {"name": "Circuit de Spa-Francorchamps"}
}
